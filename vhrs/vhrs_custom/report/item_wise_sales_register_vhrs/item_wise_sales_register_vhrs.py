...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
    ...
    for d in item_list:
        ...
        row = [d.item_code, d.item_name, d.item_group, d.parent,
               d.posting_date, d.customer, d.customer_name, d.territory]
        ...
        row += [
            d.customer_group, d.debit_to, ", ".join(
                mode_of_payments.get(d.parent, [])),
...
def get_columns(additional_table_columns):
    columns = [
        ...
        _("Item Group") + ":Link/Item Group:100", _("Invoice") +
        ":Link/Sales Invoice:120",
        _("Posting Date") + ":Date:80", _("Customer") + ":Link/Customer:120",
        _("Customer Name") + "::120", _("Territory") + "::120"]
    ...
    columns += [
        ...
        _("Sales Order") + ":Link/Sales Order:100", _("Delivery Note") +
        ":Link/Delivery Note:100",
        _("Income Account") + ":Link/Account:140", _("Cost Center") +
        ":Link/Cost Center:140",
...
def get_tax_accounts(item_list, columns, company_currency,
    ...
    columns += ["Total Tax:Currency/currency:80",
                "Total:Currency/currency:100"]
